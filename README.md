...
> ⚠️ **重要公告**: winC2D 正在用 Tauri + Rust 重构！当前 main 分支将推出全新版本，旧版本代码已保存至 [csharp-legacy](../../tree/csharp-legacy) 分支。
...
[![Release](https://img.shields.io/github/v/release/Aknirex/winC2D?include_prereleases)](https://github.com/Aknirex/winC2D/releases)
...
| 版本 | 技术栈 | 状态 | 说明 |
|------|--------|------|------|
| v2.x (Tauri+Rust) | Rust | 开发中 | 跨平台、高性能、现代化 |
| v1.x (C#+WinForms) | C# .NET | 维护中 | 仅 Windows，查看 csharp-legacy |

**如何选择版本？**

- 🆕 **新用户**: 等待 v2.0 正式版（预计 2026 年 9 月）
- 👴 **现有用户**: 继续使用 C# v1.x，或升级到 Rust v2.0-beta（需反馈）
...
- [前往 Releases 页面下载最新版本](https://github.com/Aknirex/winC2D/releases)
- 需以管理员身份运行
- 支持 Windows 10/11
...
1. [切换到 csharp-legacy 分支查看代码](../../tree/csharp-legacy)
2. [下载 C# 最后稳定版本](../../releases?q=v1)
3. 该分支仅接收紧急安全补丁，不再添加新功能
...
- [Go to Releases to download the latest version](https://github.com/Aknirex/winC2D/releases)
- Run as administrator
- Supports Windows 10/11

### Getting C# Version

If you are using C# v1.x version, please:

1. [Switch to csharp-legacy branch to view code](../../tree/csharp-legacy)
2. [Download the last stable version](../../releases?q=v1)
3. This branch only receives emergency security patches and no longer adds new features
